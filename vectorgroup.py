...
# FULL VERSION (DETAILED 6-COIL CONNECTION)
# Features:
# ✅ Valid clock numbers only
# ✅ Vector group analyzer
# ✅ Static phasor diagram
# ✅ Clock phase displacement
# ✅ Detailed HV/LV six-coil terminal diagram
# ✅ A1-A2 / B1-B2 / C1-C2 and a1-a2 / b1-b2 / c1-c2
# ✅ Delta / Star / Zigzag connection logic
# ============================================================
...
angles_primary = np.radians([90, -30, 210])
...
def draw_coil(ax, x, y, label1, label2):
...
A1, A2 = draw_coil(ax3, 1, 6, "A1", "A2")
B1, B2 = draw_coil(ax3, 1, 4, "B1", "B2")
C1, C2 = draw_coil(ax3, 1, 2, "C1", "C2")
...
a1, a2 = draw_coil(ax3, 11, 6, "a1", "a2")
b1, b2 = draw_coil(ax3, 11, 4, "b1", "b2")
c1, c2 = draw_coil(ax3, 11, 2, "c1", "c2")
...
# ---------------- PHASE LABELS ----------------
ax3.text(0.3, 6, "R", fontsize=12, fontweight='bold')
ax3.text(0.3, 4, "Y", fontsize=12, fontweight='bold')
ax3.text(0.3, 2, "B", fontsize=12, fontweight='bold')

ax3.text(15.5, 6, "r", fontsize=12, fontweight='bold')
ax3.text(15.5, 4, "y", fontsize=12, fontweight='bold')
ax3.text(15.5, 2, "b", fontsize=12, fontweight='bold')
